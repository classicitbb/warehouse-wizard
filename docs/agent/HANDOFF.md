...
- Status: Incomplete — NetSuite M2M authentication fix is deployed and awaits the certificate upload in NetSuite; Release policy / fleet freshness awaits database migration and deployment approval; Copilot composer still awaits authorized browser verification
