...
export const BOARD_TILES: Record<BoardMode, BoardTileEntry[]> = {
  floor: [
    place("inbound", 0, 0, 4, 8),
    place("putaway", 4, 0, 4, 8),
    place("outbound", 8, 0, 4, 8),
    place("capacity", 0, 8, 4, 6),
    place("open-work", 4, 8, 4, 6),
    place("intelligence", 8, 8, 4, 6),
    place("moves-counts"),
    place("blocked-exceptions"),
    place("stock-status"),
    place("stock-health"),
  ],
  dock: [
    place("open-work", 0, 0, 2, 5),
    place("lane-ready", 2, 0, 2, 6),
    place("lane-called", 4, 0, 2, 6),
    place("lane-loading", 6, 0, 2, 6),
    place("lane-blocked", 8, 0, 2, 6),
    place("lane-loaded", 10, 0, 2, 6),
  ...
  office: [
    place("capacity", 0, 0, 3, 6),
    place("stock-health", 3, 0, 3, 5),
    place("open-work", 6, 0, 3, 5),
    place("dpmo", 9, 0, 3, 3),
    place("expiration-risk", 9, 3, 3, 3),
    place("reorder-watch", 0, 6, 3, 3),
    place("brain", 3, 6, 4, 8),
    place("setup-checklist", 7, 6, 5, 8),
    place("stock-status", 0, 9, 3, 4),
    place("fill-level"),
    place("intelligence"),
  ],
};
