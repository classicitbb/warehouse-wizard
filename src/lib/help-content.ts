...
const routeHelpDefinitions: Record<string, RouteHelpDefinition> = {
  ...
  "packaging-profiles": {
    ...
    keyActions: [
      "Use New profile, pick the product, then type the pack code (12x7) — the name, package type, and units per package fill themselves in and stay editable",
      "Use Save and add another to enter a run of profiles off one container",
  ...
  receiving: {
    ...
    commonMistakes: [
      ...
      "Leaving the quantity per pallet on its default of 1 — the line now says so rather than creating one pallet per unit",
      "Raising the pallet count above what the total covers — the line says how many units are over-allocated and blocks the save",
